...
model="/idiap/temp/mnafez/research/discrete-diffusion-guidance/our-trained-checkpoints/owt/checkpoints-cscs-trained/udlm/5-42000.ckpt"
...
for data in "${datasets[@]}"; do
    python -u -m main \
        ...
        T=0 \
        +val_loss_save_path="/idiap/temp/mnafez/research/discrete-diffusion-guidance/validation_loss_result/${data}_udlm"
done


datasets=("openwebtext-split" "lm1b" "ag_news")
