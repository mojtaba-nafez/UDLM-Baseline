#!/usr/bin/env bash
#SBATCH --job-name=rand_perturb_exp-threshold-disable
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
model_path="/idiap/temp/mnafez/research/discrete-diffusion-guidance/our-trained-checkpoints/owt/udlm_clean_loss_term_time_independent-v2-ablation/5-42000.ckpt"
...
do
    python -u -m random_perturbation_experiment hydra.output_subdir=null hydra.run.dir="$PWD" hydra/job_logging=disabled hydra/hydra_logging=disabled seed=1 \
        ...
        +corruption_prob=$p \
        +batch_size=64 \
        +save_path="/idiap/temp/mnafez/research/discrete-diffusion-guidance/rand_perturb_exp/threshold-disable_${dataset_name}_original_p-$p.json"
...
do
    ...
    python -u -m random_perturbation_experiment hydra.output_subdir=null hydra.run.dir="$PWD" hydra/job_logging=disabled hydra/hydra_logging=disabled seed=1 \
        ...
        +corruption_prob=$p \
        +batch_size=64 \
        +save_path="/idiap/temp/mnafez/research/discrete-diffusion-guidance/rand_perturb_exp/threshold-disable_${dataset_name}_clean_loss_p-$p.json"
