...
#SBATCH --job-name=udlm-owt-clean-term
...
#SBATCH --output=logs-train-slurm/clean-term-time-dep-%x-%j.out
#SBATCH --error=logs-train-slurm/clean-term-time-dep-%x-%j.err
